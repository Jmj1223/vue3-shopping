...
const rules = ref({
    ...
    password: [{ required: true, message: '请输入密码', trigger: 'blur' }, { min: 6, max: 14, message: '密码应该在6到14位', trigger: 'blur' },],
    agree: [{
        ...
        <section class="login-section">
            <div class="wrapper">
                ...
                <div class="account-box">
                    <div class="form">
                        <el-form ref="formRef" :model="ruleForm" :rules="rules" label-position="right"
